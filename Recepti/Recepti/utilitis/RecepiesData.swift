    ...
    func fetchRecipesById(id: String){
        ...
        URLSession.shared.dataTaskPublisher(for: url)
            ...
            .sink{
                ...
                var details = Details(idMeal: recipes["idMeald"]! ?? "", strMeal: recipes["strMeal"]! ?? "", strCategory: recipes["strCategory"]! ?? "", strArea: recipes["strArea"]! ?? "", strInstructions: [], strMealThumb: recipes["strMealThumb"]! ?? "", strTags: recipes["strTags"]! ?? "", strYoutube: recipes["strYoutube"]! ?? "", ingredients: [])
